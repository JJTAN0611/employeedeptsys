					...
					<% List<Department> departments = (List<Department>) request.getAttribute("departments");
							if (departments.size() != 0) {
								for (Department t : departments) {
									...
									out.println("<td><a href=\"MainServlet?id=" + t.getId() + "&table=department&action=edit\" class=\"text-success\"><i class=\"fas fa-marker\"></i>Update</a></td>");
									out.println("<td><a href=\"MainServlet?id=" + t.getId() + "&table=department&action=remove\" class=\"text-danger\"><i class=\"fas fa-trash-alt\"></i>Delete</a></td>");
									out.println("</tr>");
								}
							} else {
							out.println("<tr>");
