...
<div class="container top-first">
	...
	<hr>
	<div class="text-danger text-center"><jsp:getProperty name="dub" property="overall_error"/></div>
	<br> <br>
</div>
	...
	<form method="post" action="MainServlet">
		...
		<div class="form-group row">
			...
			<div class="col-8">
				...
				<div class="text-danger"><jsp:getProperty name="dub" property="id_error"/></div>
			</div>
		...
		<div class="form-group row">
			...
			<div class="col-8">
				<input type="text" class="form-control" placeholder="Enter name"
					name="dept_name" value='<jsp:getProperty name="dub" property="dept_name"/>'>
				<div class="text-danger"><jsp:getProperty name="dub" property="dept_name_error"/></div>
			</div>
		</div>
		<br>
		<div class="form-group row">
